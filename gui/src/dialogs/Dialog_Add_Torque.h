...
#ifndef DIALOG_ADD_TORQUE_H
#define DIALOG_ADD_TORQUE_H
...
namespace mars {
  ...
  namespace gui {
    ...
    /** \brief Adds a QDialog to set torque to nodes */
    class Dialog_Add_Torque : public main_gui::BaseWidget,
    ...
    private slots:
      ...
      /**\brief apply torque to selected node */
      virtual void accept();
      virtual void reject();
