  ...
  namespace interfaces {
    ...
    public:
      ...
      virtual void drawAxis(const mars::utils::Vector &first,
                            ...
                            const mars::utils::Vector &axis2) = 0;
       ...
       * \throw std::runtime_error if action is PREVIEW_COLOR and mat is NULL.
       */
      virtual void preview(int action, bool resize, 
                           const std::vector<NodeData> &allNodes,
                           unsigned int num = 0,
                           const MaterialData *mat = 0) = 0;
      ...
      virtual void showCoords(const mars::utils::Vector &pos,
                              ...
                              const mars::utils::Vector &size) = 0;
      ...
      virtual GraphicsWindowInterface* get3DWindow(unsigned long id) const = 0;
      /**
      ...
      /**\brief returns the view of a window. The first window has id 1, this is also the default value. Return 0 if the window does not exist */
