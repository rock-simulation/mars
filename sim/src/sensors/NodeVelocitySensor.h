...
#ifndef NODEVELOCITYSENSOR_H
#define NODEVELOCITYSENSOR_H

#ifdef _PRINT_HEADER_
#warning "NodeVelocitySensor.h"
#endif
...
namespace mars {
  namespace sim {
    ...
    class NodeVelocitySensor : public NodeArraySensor {

    public:
      NodeVelocitySensor(interfaces::ControlCenter *control, IDListConfig config);
      ~NodeVelocitySensor(void) {}
